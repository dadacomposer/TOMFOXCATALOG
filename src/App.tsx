...
function AppLayout() {
  ...
  return (
    <div className={`w-full min-h-screen bg-[#fafafa] text-black font-sans selection:bg-black selection:text-white flex flex-col motion-drawer no-radius !rounded-none ${currentTrack && !location.pathname.startsWith('/studio') && !location.pathname.startsWith('/admin') && location.pathname !== '/' && !location.pathname.startsWith('/browse') ? 'pb-[90px]' : ''}`}>
      <ScrollToTop />
