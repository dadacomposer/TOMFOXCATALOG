...
export default function Playlists() {
  ...
  return (
    <div className="relative flex flex-col w-full min-h-screen pt-[84px] md:pt-[80px] bg-[#fafafa] text-black">
      ...
      <div 
        className={`sticky top-[84px] md:top-[80px] z-40 shrink-0 bg-[#fafafa]/85 backdrop-blur-xl w-full px-8 md:px-12 lg:px-24 flex flex-col border-b border-black/10 py-4 mb-16 shadow-sm focus-within:border-black/30 group/searchbar`}
      >
