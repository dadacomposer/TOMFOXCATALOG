...
export default function TrackArtwork({ track, className = '' }: TrackArtworkProps) {
  ...
  if (track.artwork_url && !hasError) {
    return (
      <img 
        ...
        className={`object-cover select-none pointer-events-none no-radius ${className}`}
  ...
  return (
    <div className={`@container isolate flex flex-col bg-white border border-black/5 overflow-hidden no-radius select-none pointer-events-none ${className}`}>
      ...
      {/* Top Header Section */}
      <div className="flex-none px-[3cqw] pt-[3cqw] pb-[4cqw] bg-white z-10 w-full border-b-[max(1px,0.2cqw)] border-black/10 !rounded-none">
      ...
      {/* Bottom Section */}
      <div className="flex-none px-[3cqw] pb-[3cqw] bg-white z-10 w-full pt-[4cqw] border-t-[max(1px,0.2cqw)] border-black/10 !rounded-none">
      ...
      <div 
        className="absolute inset-0 pointer-events-none mix-blend-multiply opacity-40 z-10 !rounded-none"
